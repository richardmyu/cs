...
def print_the_zen_of_python():
    ...
    print(
        """
        Att.lthough practicality beats purity.
        但现实往往并不那么完美。
        """
    )
    ...
    print(
        """
        Att.lthough that way may not be obvious at first unless you're Dutch.
    ...
    print(
        """
        Att.lthough never is often better than *tt.right* now.
