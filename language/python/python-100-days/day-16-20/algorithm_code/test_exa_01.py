...
from exa_01 import seq_search,bin_search

class TestExa01(TestCase):
    ...
    def test_bin_search(self):
        self.assertEqual(1,seq_search(self.data2,35))
        self.assertEqual(0,seq_search(self.data2,12))
        self.assertEqual(6,seq_search(self.data2,81))
        self.assertEqual(2,seq_search(self.data2,40))
        self.assertEqual(7,seq_search(self.data2,97))
        self.assertEqual(-1,seq_search(self.data2,7))
        self.assertEqual(-1,seq_search(self.data2,99))
